...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">Registrasi Pendonor Baru & Cek Kelayakan</p>
            <p class="subtitle">Isi data medis untuk mengetahui apakah Anda layak menjadi pendonor saat ini.</p>
        </header>
        ...
        <div class="main-content">
            ...
            <div class="request-section">
                ...
                <form id="donorForm">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col">
                            <div class="input-group">
                                ...
                                <input type="tel" id="contact_number" class="input-field" placeholder="08xxxxxxxxxx"
                                    required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="input-group">
                                ...
                                <input type="number" id="jarak_ke_rs_km" class="input-field" min="0" step="0.1"
                                    value="10.0" placeholder="Estimasi jarak">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="input-group">
                                ...
                                <input type="number" id="usia" class="input-field" min="17" max="65" value="25"
                                    required>
                        ...
                        <div class="form-col">
                            <div class="input-group">
                                ...
                                <input type="number" id="berat_badan" class="input-field" min="45" value="60"
                                    required>
                        ...
                        <div class="form-col">
                            <div class="input-group">
                                ...
                                <input type="number" id="hb_level" class="input-field" min="11" max="18" step="0.1"
                                    value="13.5" required>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col">
                            <div class="input-group">
                                ...
                                <input type="number" id="months_since_first_donation" class="input-field" min="0"
                                    value="0">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-info">
                        ...
                        <span>Data Anda akan diproses oleh sistem Machine Learning kami untuk memverifikasi kelayakan
                            donor secara otomatis.</span>
                    </div>

                    <!-- Auto-fill button for demo -->
                    <button type="button" onclick="fillTestData()"
                        style="margin-top: 15px; background: none; border: 1px dashed #ccc; color: #666; width: 100%; padding: 10px; cursor: pointer; border-radius: 8px;">
            ...
            <div class="recommendation-section">
                ...
                <div class="info-card">
                    ...
                    <div class="info-text"><i class="fas fa-check-circle" style="color: green; margin-right: 5px;"></i>
                        Usia 17 - 60 tahun</div>
                    <div class="info-text"><i class="fas fa-check-circle" style="color: green; margin-right: 5px;"></i>
                        Berat badan minimal 45 kg</div>
                    <div class="info-text"><i class="fas fa-check-circle" style="color: green; margin-right: 5px;"></i>
                        Kadar Hemoglobin 12.5 - 17.0 g/dL</div>
                    <div class="info-text"><i class="fas fa-check-circle" style="color: green; margin-right: 5px;"></i>
                        Sehat jasmani dan rohani</div>
                </div>
